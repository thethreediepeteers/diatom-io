...
impl Message {
    pub fn encode(&self) -> Vec<u8> {
        match self {
            ...
            Message::Uint32(u) => vec![0x07, *u as u8, (*u >> 8) as u8, (*u >> 16) as u8, (*u >> 24) as u8],
            Message::Int32(i) => vec![0x08, *i as u8, (*i >> 8) as u8, (*i >> 16) as u8, (*i >> 24) as u8],
            Message::Uint64(u) => vec![0x09, *u as u8, (*u >> 8) as u8, (*u >> 16) as u8, (*u >> 24) as u8, (*u >> 32) as u8, (*u >> 40) as u8, (*u >> 48) as u8, (*u >> 56) as u8],
            Message::Int64(i) => vec![0x0a, *i as u8, (*i >> 8) as u8, (*i >> 16) as u8, (*i >> 24) as u8, (*i >> 32) as u8, (*i >> 40) as u8, (*i >> 48) as u8, (*i >> 56) as u8],
            Message::Float32(f) => {
                let mut v = vec![0x0b];
    ...
    pub fn decode(buf: &[u8]) -> Self {
        ...
        match message_type {
            ...
            0x07 => Message::Uint32((buf[1] as u32) + ((buf[2] as u32) << 8) as u32 + ((buf[3] as u32) << 16) as u32 + ((buf[4] as u32) << 24) as u32),
            0x08 => Message::Int32((buf[1] as i32) + ((buf[2] as i32) << 8) as i32 + ((buf[3] as i32) << 16) as i32 + ((buf[4] as i32) << 24) as i32),
            0x09 => Message::Uint64((buf[1] as u64) + ((buf[2] as u64) << 8) as u64 + ((buf[3] as u64) << 16) as u64 + ((buf[4] as u64) << 24) as u64 + ((buf[5] as u64) << 32) as u64 + ((buf[6] as u64) << 48) as u64 + ((buf[7] as u64) << 56) as u64),
    ...
    pub fn length(&self) -> usize {
        match self {
            ...
            Message::Array(a) => 1 + 1 + if a.len() > 255 { 2 } else { 1 } + a.iter().map(|x| x.length()).sum::<usize>(),
            Message::Object(o) => 1 + 1 + if o.len() > 255 { 2 } else { 1 } + o.iter().map(|(k, v)| k.length() + v.length()).sum::<usize>()
        }
    }
}